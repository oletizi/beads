...
//				e.printStackTrace();		//
  ...
  /**
   * Gets the value of the buffer, assuming that the buffer only has one value. This is mainly a convenience method for use with {@link Static Static} type UGens. It is equivalent to {@link #getValue(0, 0)}.
   *
   * @return the value.
   */
  ...
  /**
   * Gets the value as a double. Only overridden by certain classes that generate info in doubles. Gets the value of the buffer, assuming that the buffer only has one value. This is mainly a convenience method for use with {@link Static Static} type UGens. It is equivalent to {@link #getValue(0, 0)}.
   *
   * @return the value.
   */
  ...
  /**
   * Sets the value of {@link #bufOut}. This is mainly a convenience method for use with {@link Static Static} and {@link Envelope Envelope} type UGens.
   *
